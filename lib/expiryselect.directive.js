 ...
 * @ngInject
 */
leodido.directive.ExpirySelect.prototype.link = function ($scope, $element, $attrs, ngModelController) {
//  /** @type {leodido.directive.ExpirySelect.controller} */
  var controller = $element.data('$' + leodido.constants.ExpirySelect.DIRECTIVE_NAME + 'Controller');
  console.log(controller, ngModelController);
  // Capute selections
